      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-gray-600">시행일자: 2025년 7월 1일</p>
          </CardHeader>
          <CardContent className="prose prose-sm max-w-none">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <ul>
                ...
                <li>카카오 채널: <a href="http://pf.kakao.com/_xfxcxfxaK" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">http://pf.kakao.com/_xfxcxfxaK</a></li>
                <li>1상담팀 (카카오ID: mind.channel)</li>
                <li>2진행팀 (카카오ID: mind.system)</li>
