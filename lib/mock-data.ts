...
export const mockCustomers: Customer[] = [
  ...
  },
  {
    ...
    sourceChannel: '서울 그랜드 웨딩홀',
    sourceType: 'venue-referral',
    venuePartnerId: 'venue-001',
    leadStatus: 'inquiry',
    assignedManagerId: 'user-2',
    assignedManager: mockUsers[1],
  ...
  },
  {
    ...
    sourceChannel: '수동 등록',
    sourceType: 'manual-registration',
  ...
  },
  {
    ...
    groomPhone: '010-9999-0000',
    bridePhone: '010-1212-3434',
    email: 'couple12@example.com',
    sourceChannel: '웨딩 플래너 제휴',
    sourceType: 'venue-referral',
    venuePartnerId: 'venue-002',
    leadStatus: 'completed',
    satisfaction: 5,
    assignedManagerId: 'user-2',
    assignedManager: mockUsers[1],
    notes: '플래너 제휴 고객. 완벽한 촬영',
...
export const mockContracts: Contract[] = [
  ...
  // 완료 고객 계약서
  {
    ...
    packageType: 'new BASIC',
    weddingDate: '2025-04-15',
    weddingTime: '14:00',
    venue: '서울 신라호텔',
    totalAmount: 4500000,
    depositAmount: 2000000,
  ...
  },
  {
    ...
    packageType: 'BASIC',
    weddingDate: '2025-03-28',
    weddingTime: '12:00',
    venue: '강남 웨딩타운',
    totalAmount: 3200000,
    depositAmount: 1500000,
    balanceAmount: 1700000,
    groomName: '공유',
    brideName: '정유미',
    signedAt: '2025-02-28T11:00:00Z',
...
export const mockPayments: Payment[] = [
  ...
  // 완료 고객 결제 정보
  {
    ...
    receiptUrl: 'https://s3.example.com/receipts/payment-10-1.pdf',
    cashReceiptIssued: true,
    notes: '계약금 입금 완료',
  ...
  },
  {
    ...
    receiptUrl: 'https://s3.example.com/receipts/payment-10-2.pdf',
    cashReceiptIssued: true,
    notes: '잔금 카드 결제 완료',
  ...
  },
  {
    ...
    receiptUrl: 'https://s3.example.com/receipts/payment-11-1.pdf',
    cashReceiptIssued: true,
    notes: '계약금 입금 완료',
  ...
  },
  {
    ...
    receiptUrl: 'https://s3.example.com/receipts/payment-11-2.pdf',
    cashReceiptIssued: true,
    notes: '잔금 입금 완료',
  ...
  },
  {
    ...
    receiptUrl: 'https://s3.example.com/receipts/payment-12-1.pdf',
    cashReceiptIssued: true,
    notes: '계약금 카드 결제 완료',
  ...
  },
  {
    ...
    receiptUrl: 'https://s3.example.com/receipts/payment-12-2.pdf',
    cashReceiptIssued: true,
    notes: '잔금 입금 완료',
  ...
  },
  {
    ...
    receiptUrl: 'https://s3.example.com/receipts/payment-13-1.pdf',
    cashReceiptIssued: true,
    notes: '계약금 입금 완료',
  ...
  },
  {
    ...
    receiptUrl: 'https://s3.example.com/receipts/payment-13-2.pdf',
    cashReceiptIssued: true,
    notes: '잔금 현금 결제 완료',
  ...
  // 추가 결제 예시 (복합 결제 방식)
  {
    ...
    receiptUrl: 'https://s3.example.com/receipts/payment-1-additional.pdf',
    cashReceiptIssued: true,
    notes: '추가 앨범 제작 비용',
...
export const mockProjects: Project[] = [
  ...
  },
  {
    ...
    optionIds: [],
    projectStatus: 'scheduled',
    weddingDate: format(addDays(new Date(), 2), 'yyyy-MM-dd'),  // 오늘 +2일 (다른 촬영과 겹치는 날짜)
    weddingTime: '오후 3시',
  ...
  // 완료된 프로젝트 (완료 탭용)
  {
    ...
    weddingDate: '2025-04-15',
    weddingTime: '14:00',
    weddingVenue: '서울 신라호텔',
    makeupInfo: '호텔 내 뷰티살롱 (12:00)',
    specialRequests: '가족 사진 중요',
    referralSource: 'Naver Blog',
    assignedPhotographerIds: ['photographer-1', 'photographer-2'],
    assignedPhotographers: [mockPhotographers[0], mockPhotographers[1]],
    assignedEditorId: 'editor-1',
    assignedEditor: mockUsers[4],
  ...
  },
  {
    ...
    weddingDate: '2025-06-10',
    weddingTime: '13:00',
    weddingVenue: '제주 신라호텔',
    makeupInfo: '호텔 스위트룸 (11:00)',
    specialRequests: '해변 야외 촬영',
    referralSource: '웨딩 플래너 제휴',
    assignedPhotographerIds: ['photographer-2', 'photographer-3'],
    assignedPhotographers: [mockPhotographers[1], mockPhotographers[2]],
    assignedEditorId: 'editor-1',
    assignedEditor: mockUsers[4],
  ...
  },
  {
    ...
    weddingDate: '2025-03-28',
    weddingTime: '12:00',
    weddingVenue: '강남 웨딩타운',
    makeupInfo: '웨딩홀 내 메이크업샵 (10:00)',
    specialRequests: '실내 촬영 위주',
    referralSource: '수동 등록',
    assignedPhotographerIds: ['photographer-1'],
    assignedPhotographers: [mockPhotographers[0]],
    assignedEditorId: 'editor-1',
    assignedEditor: mockUsers[4],
